...
namespace Physics
{
    public static class PhysicalUtil
    {
        ...
        {
            return (float)gameTime.ElapsedGameTime.TotalSeconds / interval;
        }
        ...
        public static bool IntersectSegments(Vector2 a, Vector2 b, Vector2 c, Vector2 d, out Vector2 ip)
        {
            ...
            if (!IntersectSegmentsFast(a.X, a.Y, b.X, b.Y, c.X, c.Y, d.X, d.Y))
            {
                return false;
            }
        ...
        {
            return
                MathF.Abs(a.X - b.X) <= VerySmallAmount &&
                MathF.Abs(a.Y - b.Y) <= VerySmallAmount;
        }
    }
}
