...
namespace Physics
{
    public static class CollisionHandler
    {
        ...
        {
            { typeof(Player), new() { typeof(PlatformEntity), typeof(HumanoidEntity), typeof(AnimalMob), typeof(LedgeEntity), typeof(WaterTileEntity), typeof(LadderEntity), typeof(SpikeEntity) } },
            { typeof(HumanoidEntity), new() { typeof(AnimalMob), typeof(HumanoidEntity), typeof(WaterTileEntity), typeof(LadderEntity), typeof(SpikeEntity) } },
            { typeof(AnimalMob), new() { typeof(AnimalMob), typeof(WaterTileEntity), typeof(LadderEntity), typeof(SpikeEntity) } },
            { typeof(InteractiveItemEntity), new() { typeof(AnimalMob), typeof(HumanoidEntity), typeof(Player), typeof(InteractiveItemEntity), typeof(WaterTileEntity), typeof(LadderEntity), typeof(SpikeEntity) } },
            { typeof(DestroyableEntity), new () { typeof(WaterTileEntity), typeof(LadderEntity), typeof(SpikeEntity) } }
        };
        ...
        public static bool IgnoreCollision(PhysicalBody bodyA, PhysicalBody bodyB, bool additional = false)
        {
            ...
            //platforms
            if (!Entities.Entities.Player.EntityControlHandler.ControlStateMap[Inputs.KeyHandler.KeyStates.MOVEDOWNPRESSED])
            {
