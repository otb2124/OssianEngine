...
namespace Resources
{
    public static class StaticSpriteFactory
    {
        ...
        public static Dictionary<ItemKey, Point> itemUISpriteMappings = new()
        {
            ...
            { new ItemKey(ItemLib.Accessories.LEATHER_CAPE), new Point(0,6) },
            { new ItemKey(ItemLib.Accessories.IRON_BELT), new Point(0,7) },
            { new ItemKey(ItemLib.Accessories.IRON_RING), new Point(0,8) },
            { new ItemKey(ItemLib.Accessories.CALL_DOG), new Point(0,9) },
            { new ItemKey(ItemLib.Accessories.CALL_FIREFLY), new Point(0,10) },
            { new ItemKey(ItemLib.Accessories.BACKPACK), new Point(0,11) },
