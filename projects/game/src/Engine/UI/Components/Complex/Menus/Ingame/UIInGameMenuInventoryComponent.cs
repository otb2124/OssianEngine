...
namespace UI
{
    public class UIInGameMenuInventoryComponent : UIComponent
    {
        ...
        public UIInGameMenuInventoryComponent(int id) : base(id)
        {
            ...
            children[0] = new UIInventoryEquipmentExchangeComponent(-1, new Vector2(100, 500), Entities.Entities.Player.Inventory, Entities.Entities.Player.EquipmentManager, Entities.Entities.Player.BattleBodyManager);
        }
