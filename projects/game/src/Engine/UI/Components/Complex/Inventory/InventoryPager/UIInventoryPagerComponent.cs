...
namespace UI
{
    public class UIInventoryPagerComponent : UIComponent
    {
        ...
        public UIInventoryPagerComponent(int id, Vector2 pos, string indicatorValue) : base(id)
        {
            ...
            children[0] = new UIButtonIconComponent(-1, -1, new Vector2(Position.X, Position.Y), new StaticSprite(SpriteSheets.UI_ICONS, new Rectangle(0, 64+64, 32, 32), 0), new Vector2(0.75f, 0.75f));
            children[1] = new UIButtonIconComponent(-1, -1, new Vector2(Position.X + 250, Position.Y), new StaticSprite(SpriteSheets.UI_ICONS, new Rectangle(32, 64+64, 32, 32), 0), new Vector2(0.75f, 0.75f));
